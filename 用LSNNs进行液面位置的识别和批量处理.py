...
if __name__ == "__main__":
    data_paths = [
        'F:\\ProofingTool\\数据\\141361363626636_OriData_20220801154803.ini',
        'F:\\ProofingTool\\数据\\other_data_file_1.ini',
        'F:\\ProofingTool\\数据\\other_data_file_2.ini'
    ]
    batch_process(data_paths)
