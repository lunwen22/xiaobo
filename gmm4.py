...
from sklearn.impute import SimpleImputer  # 用于处理 NaN
...
def extract_signal_features(signal):
    ...
    high_freq_noise = np.mean(psd[freqs > 0.5])  # 假设 0.5 以上是高频噪音

    return amplitude, std_dev, energy, peaks, high_freq_noise
...
if __name__ == "__main__":
    ...
    output_folder = r"D:\shudeng\波形图\结果1\BIC_AIC_gmm_分类结合结果4"
